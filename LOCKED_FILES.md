...
| `tradier_manage.py` | RELOCKED 2026-04-20 19:55 | **2026-04-20 19:55 NEW**: PEAK_GIVEBACK_PROTECTION + DC_LOW4_5M block added to evaluate_stop() BEFORE STOCK_MIN_HOLD and UNIVERSAL_NOLOSS_GATE. Closes positions that were profitable (max_gain >= PEAK_GIVEBACK_MIN_PEAK_PCT=0.3%) and fall negative after grace period (BREAKEVEN_GRACE_MINUTES=15min). DC_LOW4_5M/DC_HIGH4_5M structural stop fires any time position was ever profitable. Backup: before_peak_giveback_tradier_*. DO NOT remove or move PEAK_GIVEBACK block below NOLOSS gate. **Prior (2026-04-20 17:00)**: LE scorer extended to ALL tradier accounts. | user |
| `config_tradier.py` | RELOCKED 2026-04-20 19:55 | **2026-04-20 19:55 NEW**: Added PEAK_GIVEBACK_PROTECTION_ENABLED=True, PEAK_GIVEBACK_MIN_PEAK_PCT=0.3, PEAK_GIVEBACK_DROP_PCT=2.0, PEAK_GIVEBACK_HARD_ZERO_ENABLED=True alongside existing BREAKEVEN_DC_LOW4_ENABLED/BREAKEVEN_GRACE_MINUTES. Backup: before_peak_giveback_ct_*. DO NOT disable PEAK_GIVEBACK without explicit permission. **Prior (2026-04-20)**: SRS k-thresholds tightened. | user |
