...
| `config.py` | RELOCKED 2026-04-14 02:40 | **2026-04-14 02:40 NEW**: STRUCTURAL_RANGE_SHIFT_K_HIGH=75, _K_LOW=25, _PROXIMITY_BPS=100 (cascade knobs). Prior: BOUNCE_AUGMENT_* configs 2026-04-14 00:50. Prior: EXIT_HARD_MAX_LOSS_CAP_ENABLED=False, HARD_MAX_LOSS_PCT=-999, RZ_K_EXIT=95, UNIVERSAL_NOLOSS_GATE=True. Backup: backups/before_srs_cascade_cfg_202604140235.py. DO NOT re-enable HARD_MAX_LOSS_CAP. DO NOT set RZ_K_EXIT<90. DO NOT remove SRS cascade knobs. | user |
