...
| ~~`tradier_manage.py`~~ | UNLOCKED 2026-04-20 21:00 | Unlocked to wire LOCAL_EXTREMES_MIN_SCORE entry gate + DYNAMIC_SCORE_COUNTER_EXIT in evaluate_stop() | **2026-04-20 20:15 NEW**: NOLOSS_BB1H_GATE added to evaluate_stop() before STOCK_MIN_HOLD — if gain<0 AND price broke OUTSIDE bb_1h in wrong direction (LONG: price<bb_lower_1h, SHORT: price>bb_upper_1h) → override NO_LOSS and close (structural breakdown). Switch: NOLOSS_BB1H_GATE_ENABLED=True. Backup: before_bb1h_noloss_gate_*. DO NOT remove or disable without sweep proof. **Prior (2026-04-20 20:00)**: PEAK_GIVEBACK threshold 0→0.08. DO NOT remove PEAK_GIVEBACK or move it below NOLOSS gate. | user |
