...
| `ez_positions_quick.py` | RELOCKED 2026-04-20 20:00 | **2026-04-20 NEW**: PEAK_GIVEBACK threshold `current_gain < 0` → `current_gain < 0.08` (close at near-breakeven to pass UNIVERSAL_NOLOSS_GATE; negative closes blocked). Backup: before_pgp_threshold_quick_*. DO NOT revert threshold below 0.08. **Prior (2026-04-14 02:40)**: SRS CASCADE, DO NOT revert cascade to flat approach trigger. DO NOT remove delta_sig, tracker sync, hedge engine, WT_GATE_BYPASS_RZ, wt_3m hedge kill, HEDGE_PROFIT_PROTECT, PARABOLIC_EXHAUSTION_EXIT, _hedge_entry_is_valid, GAIN_EROSION, STRUCTURAL_RANGE_SHIFT_EXIT cascade, or the PREEMPTIVE_BREAKEVEN toggle. | user |
...
| `tradier_manage.py` | RELOCKED 2026-04-20 20:00 | **2026-04-20 20:00 NEW**: PEAK_GIVEBACK threshold `gain < 0` → `gain < 0.08` (close at near-breakeven to pass NOLOSS gate; negative closes are blocked). **Prior (2026-04-20 19:55)**: PEAK_GIVEBACK_PROTECTION + DC_LOW4_5M block in evaluate_stop() before STOCK_MIN_HOLD and UNIVERSAL_NOLOSS_GATE. DO NOT remove or move PEAK_GIVEBACK block below NOLOSS gate. DO NOT revert threshold below 0.08. | user |
