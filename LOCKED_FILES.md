...
| `tradier_manage.py` | RELOCKED 2026-04-20 16:15 | **2026-04-20 16:15 NEW**: reentry_monitor_loop — Pathway G REENTRY_60MIN_UNCONDITIONAL: if within 60min of exit AND price moved ≥0.3% in trade direction → reenter at 50% size, no other gates. Fixes: _g60_fired excluded from all 3 tier gates; reentry_qty ×0.5 when _g60_fired; also applies ×0.5 to _fav_k15m_partial (was logged-only, not applied). NOLOSS bypass: DD_BOUNCE_STOP added to _en_srs bypass. Backups: before_60min_reentry_*, before_dd_bounce_stop_noloss_bypass_*. DO NOT remove _g60_fired from tier gates. DO NOT remove _is_wt_d_aug from execute_now gates. **Prior (2026-04-20 15:05)**: wt_D bounce augment + LE_SCORER block. | user |
| `config_tradier.py` | RELOCKED 2026-04-20 16:15 | **2026-04-20 16:15 NEW**: REENTRY_60MIN_UNCONDITIONAL_ENABLED=True, REENTRY_60MIN_WINDOW_MIN=60.0, REENTRY_60MIN_MIN_PCT=0.3. REENTRY_FAVORABLE_HTF_MIN lowered 2→1 (1h is always bearish after exit). Backups: before_60min_reentry_ct_*. DO NOT re-raise REENTRY_FAVORABLE_HTF_MIN to 2. **Prior (2026-04-20 14:39)**: TRC budget unlocked for local extremes. | user |
