...
| `tradier_manage.py` | RELOCKED 2026-04-14 03:10 | Prior: all earlier patches. **2026-04-14 03:10 NEW**: WT_CROSSUNDER_FINAL standalone block in evaluate_stop — fires independently when DELTA_ENGINE_ENABLED=False (was trapped inside delta gate block, making sweep switch dead). Backup: backups/before_wt_xu_dedent_202604140310.py. DO NOT revert standalone WT_CROSSUNDER block. DO NOT revert cascade. DO NOT remove SRS bypass in execute_now. | user |
| `config_tradier.py` | RELOCKED 2026-04-14 02:40 | **2026-04-14 02:40 NEW**: STRUCTURAL_RANGE_SHIFT_EXIT=True (was False), _TF="bb_1h" (was bb_4h), _K_HIGH=75, _K_LOW=25, _PROXIMITY_BPS=100. Backup: backups/before_srs_cascade_cfgtra_202604140235.py. DO NOT revert SRS to False (live with cascade). | user |
