...
| `ez_indicators.py` | RELOCKED 2026-04-25 22:40 | Prior: 2026-04-20 15m gap-fill fix. **2026-04-25 NEW**: Added `kc_features()` (Keltner Channel: EMA(20) ± 1.5×ATR) and `squeeze_features()` (LazyBear/TTM Squeeze: ON when BB inside KC, fire on release) after bb_features. Pure helpers, no live wiring yet — sweep validation required (Improvement Framework A3). Backup: before_kc_squeeze_add_202604252235.py. md5 0b0a37a2b2e0b6c4d00df339077f2b30 (MacBook+S1+S2). DO NOT remove kc_features or squeeze_features. | user |
| `backtest_v8_precompute.py` | RELOCKED 2026-04-25 22:40 | Prior: 2026-04-04 fabricate_3m/5m. **2026-04-25 NEW**: Added NPZ fields kc_upper_{tf}, kc_mid_{tf}, kc_lower_{tf}, squeeze_{tf} (1=BB inside KC), squeeze_fire_{tf} (+1 bull / -1 bear release / 0). Vectorized via close.ewm + ATR(20) on TR-max. Inserted after BB block (~line 293). Backup: before_kc_squeeze_npz_202604252235.py. md5 58f3e569ffba5f7901ee8862432eb0a0. NPZ MUST be REGENERATED before any sweep can use new fields. DO NOT remove KC/Squeeze block. | user |
