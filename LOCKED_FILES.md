...
| `config_tradier.py` | RELOCKED 2026-04-20 | **2026-04-20 NEW**: TRC_ORB/EPISODIC_PIVOT/SQUEEZE/MOMENTUM_FADE_ENABLED=False (disabled experimental overlays — trc now runs local extremes only). TRC_ENTRY_ZONE_LONG=25.0 (was 30), TRC_ENTRY_ZONE_SHORT=75.0 (was 70) — deeper extremes gate. Backup: backups/before_trc_local_extremes_*.py. **Prior**: ENTRY/REENTRY_SYMGATE=False, RANK_CONVICTION/DC_MOMENT/WINNER_PROTECT all False. | user |
