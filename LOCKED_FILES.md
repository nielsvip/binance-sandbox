...
| `tradier_manage.py` | RELOCKED 2026-04-14 02:40 | **2026-04-14 02:40 NEW**: STRUCTURAL_RANGE_SHIFT_EXIT rewritten as CASCADE (same logic as ez_positions_quick, default TF bb_1h for stocks). Added SRS bypass to execute_now STRICT_NO_LOSS guard (EXECUTE_NOW_NOLOSS_SRS_BYPASS). Backup: backups/before_srs_cascade_tm_202604140235.py. DO NOT revert cascade. DO NOT remove SRS bypass in execute_now. | user |
