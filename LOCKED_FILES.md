...
| `ez_positions_quick.py` | RELOCKED 2026-04-14 02:40 | Prior: all earlier patches incl PREEMPTIVE_BREAKEVEN toggle. **2026-04-14 02:40 NEW**: STRUCTURAL_RANGE_SHIFT_EXIT rewritten as CASCADE (LONG: entry>upper + k_1h/15m>=75 turning down + wt bearish + proximity + wt_3m bearish cross. SHORT: entry>lower + k_1h/15m<=25 turning up + wt bullish + proximity + wt_3m bullish cross). Backup: backups/before_srs_cascade_quick_202604140235.py. DO NOT revert cascade to flat approach trigger. DO NOT remove delta_sig, tracker sync, hedge engine, WT_GATE_BYPASS_RZ, wt_3m hedge kill, HEDGE_PROFIT_PROTECT, PARABOLIC_EXHAUSTION_EXIT, _hedge_entry_is_valid, GAIN_EROSION, STRUCTURAL_RANGE_SHIFT_EXIT cascade, or the PREEMPTIVE_BREAKEVEN toggle. | user |
...
| `config.py` | RELOCKED 2026-04-19 21:03 | **2026-04-19 NEW**: CT_WT_VELOCITY_1H_MIN=8.0 (was 6.0, broken-data winner), REENTRY_RALLY_K15M_MAX=100 (disabled, was 40), ENTRY/REENTRY_SYMGATE=False, RANK_CONVICTION=False, DC_MOMENT=False (all Chapter-C/E on broken B15/B11 data), RZ_EXIT_ENABLED=False (premature exits, Sharpe 2.5→1.25), V8Q_MIN_HOLD_BARS=250, V8Q_WT_EXIT_MIN_TFS=3. Snapshot: snapshots/crypto_sharpe_255_20260419_2103. Backup: backups/before_crypto_best_settings_202604192005.py. **Prior**: SRS cascade knobs, BOUNCE_AUGMENT_*, EXIT_HARD_MAX_LOSS_CAP_ENABLED=False, RZ_K_EXIT=95. DO NOT re-enable HARD_MAX_LOSS_CAP. DO NOT set RZ_K_EXIT<90. DO NOT remove SRS cascade knobs. DO NOT re-enable RZ_EXIT without sweep proof. | user |
...
| `tradier_manage.py` | RELOCKED 2026-04-20 15:05 | Prior: all earlier patches. **2026-04-20 15:05 NEW**: evaluate_augment — wt_D bounce augment (WT_D_BOUNCE_AUG_ENABLED). execute_now — `_is_wt_d_aug` bypass on all 4 gain gates. Backup: backups/before_wt_d_aug_live_*.py. DO NOT remove `_is_wt_d_aug` from any of the 4 gates. **2026-04-20 14:39 PRIOR**: import local_extremes_scorer; LE_SCORER block in process_position — when account_key=='trc' and TRC_LOCAL_EXTREMES_SCORER_ENABLED=True, calls score_local_extremes(indicators_raw, is_long) to override qty with score-dynamic $50-$5000 sizing, skips trade if score<15. Backup: backups/before_trc_scorer_wire_202604201439.py. DO NOT revert 4H hard block. DO NOT revert SRS bypass. DO NOT remove LE_SCORER block or import. | user |
| `config_tradier.py` | RELOCKED 2026-04-20 14:39 | **2026-04-20 14:39 NEW**: TRC budget unlocked for local extremes: TRC_START_POSITION_SIZE=1000 (scorer overrides $50-$5000), TRC_MAX_POSITION_SIZE=5000, TRC_MAX_SYMBOL_VALUE=5000, TRC_SCALP_MAX_POSITIONS_PER_SIDE=20, TRC_MAX_CONCURRENT_POSITIONS=40, TRC_SWING_LONG/SHORT_BUDGET=100000, TRC_LOCAL_EXTREMES_SCORER_ENABLED=True. Backup: backups/before_trc_budget_scorer_202604201439.py. DO NOT change TRB budget values. DO NOT raise TRC_MAX_POSITION_SIZE above 5000 without sweep proof. **Prior**: TRC overlays disabled, ENTRY_ZONE_LONG=25/SHORT=75. | user |
| `ez_manage.py` | RELOCKED 2026-04-14 02:40 | **2026-04-14 02:40 NEW**: Added SRS bypass to IMMEDIATE_REDUCE_BLOCKED_NOLOSS (_imm_srs check). UNIVERSAL_NOLOSS_GATE already had SRS bypass. Backup: backups/before_srs_cascade_em_202604140235.py. DO NOT remove SRS bypass. | user |
