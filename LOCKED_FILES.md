...
| `tradier_manage.py` | RELOCKED 2026-04-20 17:00 | **2026-04-20 17:00 NEW**: LE scorer extended to ALL tradier accounts (was trc-only). `account_key=='trc' and TRC_LOCAL_EXTREMES_SCORER_ENABLED` → `TRADIER_LOCAL_EXTREMES_SCORING_ENABLED` (applies trb+trc). Log tag changed from `[trc]` to `[{account_key}]`. Backup: before_le_all_accounts_tradier_*. DO NOT re-add account_key=='trc' restriction. **Prior (2026-04-20 16:15)**: 60min unconditional reentry + DD_BOUNCE_STOP NOLOSS bypass. | user |
| `config_tradier.py` | RELOCKED 2026-04-20 | **2026-04-20 NEW**: SRS k-thresholds tightened: STRUCTURAL_RANGE_SHIFT_K_HIGH 75→85, K_LOW 25→15. Added SRS_K_EXIT_1H=85, STOCH_1H_EXIT_K_MIN=85, EXIT_SCORER_K_EXTREME=85, K_LOWER_HIGH_EXIT_ENABLED=True, K_LOWER_HIGH_LTF_THRESHOLD=65, K_LOWER_HIGH_EXTREME=95. Backups: before_k_threshold_ct_*. DO NOT re-loosen SRS_K_HIGH below 85 or SRS_K_LOW above 15 without sweep proof. **Prior**: TRADIER_LOCAL_EXTREMES_SCORING_ENABLED=True, REENTRY_60MIN_UNCONDITIONAL_ENABLED=False. | user |
