...
| `tradier_manage.py` | RELOCKED 2026-04-19 | Prior: all earlier patches. **2026-04-19 NEW**: evaluate_reentry — removed hard 4H_WT block (was blocking PLTR LONG reentry when 4h bearish despite 1h+15m bullish). Now 4h counts in WT tally (2 of 4: 5m/15m/1h/4h). Added [REENTRY_GATE] logging. Added 2h overdue bypass to STOCH_GATE rising requirement. Backup: backups/before_reentry_4h_gate_fix_*.py. DO NOT revert 4H hard block. DO NOT revert standalone WT_CROSSUNDER block. DO NOT revert cascade. DO NOT remove SRS bypass in execute_now. | user |
| `config_tradier.py` | RELOCKED 2026-04-19 21:10 | **2026-04-19 NEW**: ENTRY/REENTRY_SYMGATE=False (t4 sweeps all 0-trade pre-DC-band-fix, engine default=False). Added RANK_CONVICTION/DC_MOMENT/WINNER_PROTECT (all False — no clean tradier sweep). Backup: backups/before_tradier_symgate_fix_202604192110.py. Snapshot: S2:snapshots/tradier_clean_symgate_off_20260419_2110. **Prior**: REENTRY_RALLY_HTF_MIN=3, SRS, bb_1h TF, K_HIGH=75, K_LOW=25. | user |
