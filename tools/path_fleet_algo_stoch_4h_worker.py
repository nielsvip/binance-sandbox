#!/usr/bin/env python3
"""Run the decomposed completed-4h Stoch-roll family over frozen entries."""
...
def main() -> int:
    ...
    ap.add_argument("--worker", default="path-fleet-algo-stoch-4h")
    args = ap.parse_args()
    ...
    summary = {
        ...
        "contract": {
            "candidate_count_per_key": 12,
            "event_type": "STOCH_4H_ROLL",
    ...
    fleet.finish(
        ...
        summary_path,
        (
            f"{PATH_ID} mirrored 4h keys={len(summary['symbols'])}; "
