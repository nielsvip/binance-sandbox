...
def score_exit(indicators: dict, is_long: bool, current_price: float = 0.0, cfg=None) -> tuple:
    ...
    wt_cross_1h = str(indicators.get("wt_cross_1h", ""))
    ...
    _diag = f"1h={wt_cross_1h}_4h={c2_4h_against}_D={c3_D_against}_k1h={k_1h:.0f}/k4h={k_4h:.0f}_dc1h={dc_pos_1h:.2f}/dc4h={dc_pos_4h:.2f}"
    if _hits >= _min_cond:
