# SWITCH_MATRIX_TRB progress digest — 2026-07-27 02:33:39Z
...
- Generic DB activity (includes historical/stage tables): `2026-07-27T02:24:00Z` (9m old); it is not matrix freshness.
...
- `SWITCH_MATRIX_TRB.xlsx`: 2026-07-27 02:30:42Z (2m old, 388,995 bytes)
- `SWITCH_MATRIX_TRB.csv.gz`: 2026-07-27 02:30:05Z (3m old, 35,938 bytes)
- Description coverage in current CSV: **3,537/3,537** rows.
...
| `ENTRY_DISASTER_GUARD_ENABLED` | IBIT_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 0.000% | 28.318% | 0.000× | -28.318pp | 0.000pp | 0.00% | 0 |
| `ENTRY_DISASTER_GUARD_ENABLED` | IBIT_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 0.000% | 28.318% | 0.000× | -28.318pp | 0.000pp | 0.00% | 0 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REDUNDANT_ALL_FOLD_PASS | 3.692% | -69.997% | —× | 73.689pp | 1.316pp | 9.62% | 21 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REDUNDANT_ALL_FOLD_PASS | 2.159% | -69.997% | —× | 72.156pp | -0.216pp | 9.49% | 19 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REDUNDANT_ALL_FOLD_PASS | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REDUNDANT_ALL_FOLD_PASS | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REDUNDANT_ALL_FOLD_PASS | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REDUNDANT_ALL_FOLD_PASS | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | VECTOR_SURVIVOR_EXACT_PENDING | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REDUNDANT_ALL_FOLD_PASS | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REDUNDANT_ALL_FOLD_PASS | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REDUNDANT_ALL_FOLD_PASS | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REDUNDANT_ALL_FOLD_PASS | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | -3.905% | -119.050% | —× | 115.145pp | -8.915pp | 6.56% | 16 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | -2.361% | -119.050% | —× | 116.689pp | -7.371pp | 6.15% | 14 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 5.010% | -119.050% | —× | 124.060pp | 0.000pp | 4.36% | 7 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 4.676% | -119.050% | —× | 123.726pp | -0.334pp | 4.42% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 5.010% | -119.050% | —× | 124.060pp | 0.000pp | 4.36% | 7 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 5.010% | -119.050% | —× | 124.060pp | 0.000pp | 4.36% | 7 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 5.086% | -119.050% | —× | 124.136pp | 0.076pp | 4.53% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 5.010% | -119.050% | —× | 124.060pp | 0.000pp | 4.36% | 7 |
...
|---|---|---:|---|---:|
| ENGINE | stocks_repaired_20260725_c2 | 987 | 2026-07-27T02:24:00Z | 9m |
