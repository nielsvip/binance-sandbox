# SWITCH_MATRIX_TRB progress digest — 2026-07-27 03:10:45Z
...
- Current repaired matrix latest row: `2026-07-27T03:05:13Z` (5m old).
- Generic DB activity (includes historical/stage tables): `2026-07-27T03:05:13Z` (5m old); it is not matrix freshness.
- Current repaired-contract ENGINE rows: **6**; new current rows in 24h: **6**.
- Raw repaired-campaign pilot rows since cutoff: **987**; **981** are preserved but invalidated by the newer code+NPZ+side fingerprint, and **0** fail validation status. Blank current cells must be regenerated; they are not silently backfilled from old code.
- Historical/pre-fix ENGINE rows quarantined from current rankings: **7,603/7,609**. They remain preserved as evidence.
...
- `SWITCH_MATRIX_TRB.xlsx`: 2026-07-27 03:10:44Z (0m old, 388,470 bytes)
- `SWITCH_MATRIX_TRB.csv.gz`: 2026-07-27 03:10:05Z (0m old, 35,773 bytes)
- Description coverage in current CSV: **3,528/3,528** rows.
...
| VT_LONG | 0/3,522 | 0.0% | 2026-07-27T03:05:13Z | 5m | 6 |
...
| 2026-07-27T03:03:38Z | stocks_repaired_20260725_c2 | `STOP_PACK=BB_FROZEN_4H` | -0.2882 | 0.2744 | -0.5626 | -1.050× | 2.98% | 514 | REJECT |
| 2026-07-27T02:57:17Z | stocks_repaired_20260725_c2 | `STOP_PACK=DC_FROZEN_4H` | -0.2820 | 0.2743 | -0.5563 | -1.028× | 2.97% | 497 | INERT / RECONNECT |
| 2026-07-27T02:57:16Z | stocks_repaired_20260725_c2 | `STOP_PACK=DC_FROZEN_D` | -0.2852 | 0.2744 | -0.5596 | -1.039× | 2.98% | 506 | REJECT |
| 2026-07-27T02:56:35Z | stocks_repaired_20260725_c2 | `STOP_PACK=NEAR_ENTRY_OFF_ONLY` | -0.2820 | 0.2743 | -0.5563 | -1.028× | 2.97% | 497 | INERT / RECONNECT |
...
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | V8_EXACT_REPLAY | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | EXACT_PARITY_ONLY | 9.653% | -69.997% | —× | 79.650pp | 0.000pp | 4.21% | 8 |
...
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
...
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | LRCX_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | 2.375% | -69.997% | —× | 72.372pp | 0.000pp | 4.21% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | -3.905% | -119.050% | —× | 115.145pp | -8.915pp | 6.56% | 16 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | -2.361% | -119.050% | —× | 116.689pp | -7.371pp | 6.15% | 14 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | 5.010% | -119.050% | —× | 124.060pp | 0.000pp | 4.36% | 7 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | 4.676% | -119.050% | —× | 123.726pp | -0.334pp | 4.42% | 8 |
| `ENTRY_DISASTER_GUARD_ENABLED` | MRVL_SHORT | VEC_SHORT_GUARD_DECOMPOSITION_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | INVALIDATED_REVERSED_SLIPPAGE | 5.010% | -119.050% | —× | 124.060pp | 0.000pp | 4.36% | 7 |
...
|---|---|---:|---|---:|
| ENGINE | stocks_repaired_20260725_c2 | 987 | 2026-07-27T03:05:13Z | 5m |
