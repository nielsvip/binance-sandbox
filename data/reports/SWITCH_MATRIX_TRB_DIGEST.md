...
- Jobs: **80**; states: ADAPTER_REQUIRED=44, OBSERVABILITY_ONLY=2, QUARANTINED=8, SCREENED=26.
...
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| `ENTRY_BOUNCE_5M_LOW` | UUUU_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 22.120% | 26.197% | 0.844× | -4.077pp | 20.135pp | 24.12% | 18 |
| `ENTRY_BOUNCE_5M_LOW` | UUUU_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -313.279% | -133.049% | —× | -180.230pp | -93.499pp | 47.82% | 50 |
| `ENTRY_BOUNCE_5M_LOW` | UEC_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 58.334% | 22.648% | 2.576× | 35.686pp | 24.673pp | 25.20% | 14 |
| `ENTRY_BOUNCE_5M_LOW` | UEC_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -162.627% | -48.382% | —× | -114.246pp | 0.143pp | 46.93% | 44 |
| `ENTRY_BOUNCE_5M_LOW` | TTD_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 491.077% | 54.325% | 9.040× | 436.752pp | 210.199pp | 93.73% | 6 |
| `ENTRY_BOUNCE_5M_LOW` | TTD_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 861.580% | 141.541% | 6.087× | 720.039pp | 113.842pp | 69.29% | 24 |
| `ENTRY_BOUNCE_5M_LOW` | LDOS_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 65.404% | 37.502% | 1.744× | 27.902pp | -1.213pp | 18.18% | 8 |
| `ENTRY_BOUNCE_5M_LOW` | LDOS_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -63.584% | 13.860% | -4.587× | -77.444pp | -33.235pp | 35.41% | 55 |
| `ENTRY_BOUNCE_5M_LOW` | LAC_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 92.405% | 36.977% | 2.499× | 55.428pp | 11.949pp | 23.03% | 18 |
| `ENTRY_BOUNCE_5M_LOW` | LAC_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -505.575% | -11.541% | —× | -494.034pp | -200.647pp | 57.34% | 29 |
| `ENTRY_BOUNCE_5M_LOW` | HL_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | -6.874% | 21.954% | -0.313× | -28.829pp | -21.914pp | 22.57% | 11 |
| `ENTRY_BOUNCE_5M_LOW` | HL_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -1319.046% | -219.355% | —× | -1099.691pp | -584.347pp | 62.91% | 51 |
| `ENTRY_BOUNCE_5M_LOW` | EGO_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 27.740% | 23.025% | 1.205× | 4.715pp | 22.901pp | 27.53% | 13 |
| `ENTRY_BOUNCE_5M_LOW` | EGO_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -196.605% | -85.439% | —× | -111.166pp | 27.082pp | 29.50% | 61 |
| `ENTRY_BOUNCE_5M_LOW` | ASTS_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | -33.870% | 22.270% | -1.521× | -56.140pp | -16.749pp | 25.70% | 19 |
| `ENTRY_BOUNCE_5M_LOW` | ASTS_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -1387.426% | -153.308% | —× | -1234.118pp | -798.369pp | 66.55% | 57 |
| `ENTRY_BOUNCE_5M_LOW` | ALB_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | -8.600% | 19.412% | -0.443× | -28.013pp | -12.471pp | 36.53% | 16 |
| `ENTRY_BOUNCE_5M_LOW` | ALB_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -818.270% | -82.314% | —× | -735.956pp | 0.103pp | 64.32% | 44 |
| `ENTRY_BOUNCE_5M_LOW` | ACN_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 412.108% | 44.497% | 9.262× | 367.611pp | 24.037pp | 97.58% | 6 |
| `ENTRY_BOUNCE_5M_LOW` | ACN_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 500.744% | 69.837% | 7.170× | 430.907pp | 93.598pp | 75.58% | 32 |
| `ENTRY_BOUNCE_5M_LOW` | VLO_LONG | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 331.936% | 84.905% | 3.909× | 247.031pp | -30.351pp | 90.98% | 4 |
| `ENTRY_BOUNCE_5M_LOW` | VLO_LONG | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 517.731% | 113.267% | 4.571× | 404.464pp | 106.558pp | 71.94% | 22 |
| `ENTRY_BOUNCE_5M_LOW` | SNDK_LONG | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 2202.010% | 467.087% | 4.714× | 1734.923pp | -65.257pp | 97.58% | 7 |
| `ENTRY_BOUNCE_5M_LOW` | SNDK_LONG | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 5342.495% | 888.467% | 6.013× | 4454.028pp | -71.544pp | 96.55% | 9 |
| `ENTRY_BOUNCE_5M_LOW` | PBF_LONG | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 798.998% | 121.263% | 6.589× | 677.735pp | 223.126pp | 95.03% | 9 |
| `ENTRY_BOUNCE_5M_LOW` | PBF_LONG | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 866.475% | 127.673% | 6.787× | 738.802pp | 224.348pp | 52.58% | 44 |
| `ENTRY_BOUNCE_5M_LOW` | MU_LONG | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 1567.619% | 204.905% | 7.650× | 1362.714pp | 229.840pp | 82.85% | 8 |
| `ENTRY_BOUNCE_5M_LOW` | MU_LONG | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 2675.106% | 381.950% | 7.004× | 2293.156pp | 172.024pp | 68.78% | 21 |
| `ENTRY_BOUNCE_5M_LOW` | MRVL_LONG | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 1303.488% | 123.583% | 10.547× | 1179.906pp | 1.684pp | 96.03% | 11 |
| `ENTRY_BOUNCE_5M_LOW` | MRVL_LONG | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 1063.598% | 104.106% | 10.216× | 959.492pp | -219.491pp | 88.90% | 39 |
