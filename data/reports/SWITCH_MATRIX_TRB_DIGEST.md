# SWITCH_MATRIX_TRB progress digest — 2026-07-26 22:12:59Z
...
- Generic DB activity (includes historical/stage tables): `2026-07-26T22:11:09Z` (1m old); it is not matrix freshness.
- Current repaired-contract ENGINE rows: **0**; new current rows in 24h: **0**.
- Raw repaired-campaign pilot rows since cutoff: **878**; **878** are preserved but invalidated by the newer code+NPZ+side fingerprint, and **0** fail validation status. Blank current cells must be regenerated; they are not silently backfilled from old code.
- Historical/pre-fix ENGINE rows quarantined from current rankings: **7,500/7,500**. They remain preserved as evidence.
...
- `SWITCH_MATRIX_TRB.xlsx`: 2026-07-26 22:10:38Z (2m old, 310,771 bytes)
- `SWITCH_MATRIX_TRB.csv.gz`: 2026-07-26 22:12:27Z (0m old, 57,962 bytes)
...
- Jobs: **72**; states: ADAPTER_REQUIRED=41, OBSERVABILITY_ONLY=2, QUARANTINED=7, SCREENED=22.
...
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| `ENTRY_DC_TIER_AUG_ENABLED` | LDOS_SHORT | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 37.502% | 0.000× | -37.502pp | -66.617pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | ALB_SHORT | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 19.412% | 0.000× | -19.412pp | -3.871pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | EGO_SHORT | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 23.025% | 0.000× | -23.025pp | -4.839pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | HL_SHORT | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 21.954% | 0.000× | -21.954pp | -15.040pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | TTD_SHORT | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 54.325% | 0.000× | -54.325pp | -280.879pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | ACN_SHORT | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 44.497% | 0.000× | -44.497pp | -388.071pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | UEC_SHORT | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 22.648% | 0.000× | -22.648pp | -33.660pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | ASTS_SHORT | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 22.270% | 0.000× | -22.270pp | 17.121pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | UUUU_SHORT | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 26.197% | 0.000× | -26.197pp | -1.984pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | LAC_SHORT | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 36.977% | 0.000× | -36.977pp | -80.456pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | VLO_LONG | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 84.905% | 0.000× | -84.905pp | -362.287pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | DINO_LONG | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 90.701% | 0.000× | -90.701pp | -440.408pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | MPC_LONG | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 88.480% | 0.000× | -88.480pp | -106.892pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | PBF_LONG | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 121.263% | 0.000× | -121.263pp | -575.872pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | AMD_LONG | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 134.451% | 0.000× | -134.451pp | -1125.107pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | INTC_LONG | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 139.232% | 0.000× | -139.232pp | -778.269pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | MU_LONG | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 204.905% | 0.000× | -204.905pp | -1337.779pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | ARM_LONG | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 126.604% | 0.000× | -126.604pp | -1036.523pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | MRVL_LONG | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 123.583% | 0.000× | -123.583pp | -1301.804pp | 0.00% | 0 |
| `ENTRY_DC_TIER_AUG_ENABLED` | SNDK_LONG | WIRING_REPAIR_AUDIT | WIRING_ONLY_NO_PERFORMANCE_CLAIM; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | CONNECTED_DEFAULT_TRUE_WIRING_PROOF | 0.000% | 467.087% | 0.000× | -467.087pp | -2267.267pp | 0.00% | 0 |
...
|---|---|---:|---|---:|
| ENGINE | stocks_repaired_20260725_c2 | 878 | 2026-07-26T22:11:09Z | 1m |
