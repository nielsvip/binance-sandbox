# SWITCH_MATRIX_TRB progress digest — 2026-07-26 22:01:43Z
...
- Generic DB activity (includes historical/stage tables): `2026-07-26T21:58:24Z` (3m old); it is not matrix freshness.
- Current repaired-contract ENGINE rows: **0**; new current rows in 24h: **0**.
- Raw repaired-campaign pilot rows since cutoff: **869**; **869** are preserved but invalidated by the newer code+NPZ+side fingerprint, and **0** fail validation status. Blank current cells must be regenerated; they are not silently backfilled from old code.
- Historical/pre-fix ENGINE rows quarantined from current rankings: **7,491/7,491**. They remain preserved as evidence.
...
- `SWITCH_MATRIX_TRB.xlsx`: 2026-07-26 22:01:06Z (0m old, 545,998 bytes)
- `SWITCH_MATRIX_TRB.csv.gz`: 2026-07-26 22:00:28Z (1m old, 57,926 bytes)
...
- Jobs: **72**; states: ADAPTER_REQUIRED=42, OBSERVABILITY_ONLY=2, QUARANTINED=7, SCREENED=21.
...
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| `ENTRY_DC_TIER_AUG_ENABLED` | UUUU_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 128.224% | 26.197% | 4.895× | 102.027pp | 126.240pp | 74.35% | 9 |
| `ENTRY_DC_TIER_AUG_ENABLED` | UUUU_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -251.325% | -133.049% | —× | -118.276pp | -31.545pp | 71.68% | 27 |
| `ENTRY_DC_TIER_AUG_ENABLED` | UEC_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 24.318% | 22.648% | 1.074× | 1.671pp | -9.342pp | 76.56% | 6 |
| `ENTRY_DC_TIER_AUG_ENABLED` | UEC_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -409.203% | -48.382% | —× | -360.822pp | -246.433pp | 72.31% | 27 |
| `ENTRY_DC_TIER_AUG_ENABLED` | TTD_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 280.879% | 54.325% | 5.170× | 226.553pp | 0.000pp | 86.09% | 6 |
| `ENTRY_DC_TIER_AUG_ENABLED` | TTD_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 1129.849% | 141.541% | 7.982× | 988.308pp | 382.111pp | 85.84% | 21 |
| `ENTRY_DC_TIER_AUG_ENABLED` | LDOS_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 348.207% | 37.502% | 9.285× | 310.705pp | 281.590pp | 84.25% | 5 |
| `ENTRY_DC_TIER_AUG_ENABLED` | LDOS_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 211.187% | 13.860% | 15.237× | 197.327pp | 241.537pp | 67.61% | 40 |
| `ENTRY_DC_TIER_AUG_ENABLED` | LAC_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 397.911% | 36.977% | 10.761× | 360.934pp | 317.455pp | 62.30% | 7 |
| `ENTRY_DC_TIER_AUG_ENABLED` | LAC_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 28.606% | -11.541% | —× | 40.147pp | 333.534pp | 76.48% | 21 |
| `ENTRY_DC_TIER_AUG_ENABLED` | HL_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | -25.587% | 21.954% | -1.165× | -47.542pp | -40.628pp | 80.99% | 9 |
| `ENTRY_DC_TIER_AUG_ENABLED` | HL_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -923.236% | -219.355% | —× | -703.881pp | -188.537pp | 63.77% | 35 |
| `ENTRY_DC_TIER_AUG_ENABLED` | EGO_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | -104.661% | 23.025% | -4.545× | -127.687pp | -109.500pp | 72.08% | 7 |
| `ENTRY_DC_TIER_AUG_ENABLED` | EGO_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -706.944% | -85.439% | —× | -621.506pp | -483.257pp | 60.86% | 44 |
| `ENTRY_DC_TIER_AUG_ENABLED` | ASTS_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | -58.984% | 22.270% | -2.649× | -81.254pp | -41.863pp | 69.59% | 16 |
| `ENTRY_DC_TIER_AUG_ENABLED` | ASTS_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -891.241% | -153.308% | —× | -737.934pp | -302.185pp | 68.35% | 31 |
| `ENTRY_DC_TIER_AUG_ENABLED` | ALB_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 84.309% | 19.412% | 4.343× | 64.897pp | 80.438pp | 74.25% | 12 |
| `ENTRY_DC_TIER_AUG_ENABLED` | ALB_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | -643.430% | -82.314% | —× | -561.116pp | 174.943pp | 80.80% | 39 |
| `ENTRY_DC_TIER_AUG_ENABLED` | ACN_SHORT | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 387.658% | 44.497% | 8.712× | 343.161pp | -0.413pp | 88.44% | 4 |
| `ENTRY_DC_TIER_AUG_ENABLED` | ACN_SHORT | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 521.133% | 69.837% | 7.462× | 451.296pp | 113.988pp | 70.75% | 22 |
| `ENTRY_DC_TIER_AUG_ENABLED` | VLO_LONG | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 362.287% | 84.905% | 4.267× | 277.381pp | 0.000pp | 88.92% | 4 |
| `ENTRY_DC_TIER_AUG_ENABLED` | VLO_LONG | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 434.131% | 113.267% | 3.833× | 320.864pp | 22.958pp | 80.12% | 15 |
| `ENTRY_DC_TIER_AUG_ENABLED` | SNDK_LONG | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 2267.267% | 467.087% | 4.854× | 1800.180pp | 0.000pp | 97.38% | 5 |
| `ENTRY_DC_TIER_AUG_ENABLED` | SNDK_LONG | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 5414.039% | 888.467% | 6.094× | 4525.572pp | 0.000pp | 97.03% | 8 |
| `ENTRY_DC_TIER_AUG_ENABLED` | PBF_LONG | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 575.872% | 121.263% | 4.749× | 454.609pp | 0.000pp | 87.35% | 7 |
| `ENTRY_DC_TIER_AUG_ENABLED` | PBF_LONG | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 736.355% | 127.673% | 5.768× | 608.682pp | 94.227pp | 73.60% | 27 |
| `ENTRY_DC_TIER_AUG_ENABLED` | MU_LONG | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 1379.576% | 204.905% | 6.733× | 1174.671pp | 41.797pp | 86.15% | 10 |
| `ENTRY_DC_TIER_AUG_ENABLED` | MU_LONG | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 2739.892% | 381.950% | 7.173× | 2357.943pp | 236.811pp | 85.51% | 23 |
| `ENTRY_DC_TIER_AUG_ENABLED` | MRVL_LONG | VEC_UNTOUCHED_OOS | FINAL_CHRONOLOGICAL_OUTER_VALIDATION_FOLD; return=CAPITAL_RETURN_PCT (NONE_SINGLE_FOLD); TIM=PCT (NONE_SINGLE_FOLD) | DISCARD_GRAY | 1301.804% | 123.583% | 10.534× | 1178.221pp | 0.000pp | 73.70% | 7 |
| `ENTRY_DC_TIER_AUG_ENABLED` | MRVL_LONG | VEC_NESTED_FOLD_AGGREGATE | NESTED_OUTER_VALIDATION_FOLD_AGGREGATE; return=SUM_OF_FOLD_CAPITAL_RETURN_PCT (SUM_ACROSS_OUTER_VALIDATION_FOLDS); TIM=PCT (ROW_WEIGHTED_MEAN_ACROSS_OUTER_VALIDATION_FOLDS) | DISCARD_GRAY | 1308.052% | 104.106% | 12.565× | 1203.946pp | 24.963pp | 82.95% | 31 |
...
|---|---|---:|---|---:|
| ENGINE | stocks_repaired_20260725_c2 | 869 | 2026-07-26T21:58:24Z | 3m |
