# SWITCH_MATRIX_TRB progress digest — 2026-07-26 20:30:48Z
...
- Generic DB activity (includes historical/stage tables): `2026-07-26T20:30:30Z` (0m old); it is not matrix freshness.
- Current repaired-contract ENGINE rows: **0**; new current rows in 24h: **0**.
- Raw repaired-campaign pilot rows since cutoff: **799**; **799** are preserved but invalidated by the newer code+NPZ+side fingerprint, and **0** fail validation status. Blank current cells must be regenerated; they are not silently backfilled from old code.
- Historical/pre-fix ENGINE rows quarantined from current rankings: **7,421/7,421**. They remain preserved as evidence.
...
- `SWITCH_MATRIX_TRB.xlsx`: 2026-07-26 20:30:47Z (0m old, 310,772 bytes)
- `SWITCH_MATRIX_TRB.csv.gz`: 2026-07-26 20:30:26Z (0m old, 57,884 bytes)
...
- Jobs: **72**; states: ADAPTER_REQUIRED=45, OBSERVABILITY_ONLY=2, QUARANTINED=7, RUNNING=2, SCREENED=16.
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | EGO_SHORT | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | -85.439% | —× | 85.439pp | 223.687pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | HL_SHORT | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | -952.312% | -219.355% | —× | -732.957pp | -217.613pp | 43.76% | 22 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | HL_SHORT | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | -219.355% | —× | 219.355pp | 734.699pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | TTD_SHORT | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | 822.601% | 141.541% | 5.812× | 681.060pp | 74.863pp | 63.02% | 16 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | TTD_SHORT | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | 141.541% | 0.000× | -141.541pp | -747.738pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | ACN_SHORT | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | 424.512% | 69.837% | 6.079× | 354.675pp | 17.367pp | 66.58% | 22 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | ACN_SHORT | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | 69.837% | 0.000× | -69.837pp | -407.146pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | UEC_SHORT | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | -276.204% | -48.382% | —× | -227.823pp | -113.434pp | 44.08% | 32 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | UEC_SHORT | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | -48.382% | —× | 48.382pp | 162.771pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | ASTS_SHORT | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | -593.437% | -153.308% | —× | -440.129pp | -4.380pp | 56.33% | 27 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | ASTS_SHORT | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | -153.308% | —× | 153.308pp | 589.057pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | UUUU_SHORT | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | -395.420% | -133.049% | —× | -262.371pp | -175.640pp | 45.43% | 39 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | UUUU_SHORT | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | -133.049% | —× | 133.049pp | 219.780pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | LAC_SHORT | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | -316.576% | -11.541% | —× | -305.035pp | -11.648pp | 60.31% | 25 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | LAC_SHORT | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | -11.541% | —× | 11.541pp | 304.928pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | VLO_LONG | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | 561.563% | 113.267% | 4.958× | 448.296pp | 150.390pp | 69.78% | 15 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | VLO_LONG | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | 113.267% | 0.000× | -113.267pp | -411.173pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | DINO_LONG | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | 753.918% | 118.221% | 6.377× | 635.697pp | 222.605pp | 69.96% | 18 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | DINO_LONG | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | 118.221% | 0.000× | -118.221pp | -531.313pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | MPC_LONG | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | 295.149% | 103.592% | 2.849× | 191.557pp | 131.964pp | 55.00% | 21 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | MPC_LONG | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | 103.592% | 0.000× | -103.592pp | -163.185pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | PBF_LONG | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | 842.540% | 127.673% | 6.599× | 714.867pp | 200.413pp | 48.31% | 30 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | PBF_LONG | WIRING_AUDIT | RED_DIAGNOSTIC_DISCONNECTED | 0.000% | 127.673% | 0.000× | -127.673pp | -642.127pp | 0.00% | 0 |
| `ENTRY_DC_BREAK_ENTRY_ENABLED` | AMD_LONG | VEC_UNTOUCHED_OOS | DISCARD_GRAY_RESEARCH_RECONSTRUCTION | 1492.826% | 204.780% | 7.290× | 1288.046pp | -190.973pp | 75.44% | 18 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | VLO_LONG | VEC_UNTOUCHED_OOS | GRAY_REJECTED | 301.341% | 84.905% | 3.549× | 216.436pp | -85.966pp | 65.90% | 15 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | UUUU_SHORT | VEC_UNTOUCHED_OOS | GRAY_REJECTED | 19.893% | 26.197% | 0.759× | -6.304pp | -48.343pp | 9.45% | 65 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | UEC_SHORT | VEC_UNTOUCHED_OOS | GRAY_REJECTED | 19.748% | 22.648% | 0.872× | -2.900pp | -45.301pp | 10.29% | 34 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | TTD_SHORT | VEC_UNTOUCHED_OOS | GRAY_REJECTED | 445.436% | 54.325% | 8.199× | 391.111pp | -36.459pp | 84.00% | 14 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | SNDK_LONG | VEC_UNTOUCHED_OOS | GRAY_REJECTED | 1206.802% | 467.087% | 2.584× | 739.715pp | -1118.835pp | 83.79% | 27 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | PBF_LONG | VEC_UNTOUCHED_OOS | GRAY_REJECTED | 369.711% | 121.263% | 3.049× | 248.448pp | -337.560pp | 82.46% | 37 |
...
|---|---|---:|---|---:|
| ENGINE | stocks_repaired_20260725_c2 | 799 | 2026-07-26T20:30:30Z | 0m |
