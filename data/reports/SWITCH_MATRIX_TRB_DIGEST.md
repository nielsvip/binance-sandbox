# SWITCH_MATRIX_TRB progress digest — 2026-07-26 23:30:46Z
...
- Generic DB activity (includes historical/stage tables): `2026-07-26T23:29:50Z` (0m old); it is not matrix freshness.
- Current repaired-contract ENGINE rows: **0**; new current rows in 24h: **0**.
- Raw repaired-campaign pilot rows since cutoff: **930**; **930** are preserved but invalidated by the newer code+NPZ+side fingerprint, and **0** fail validation status. Blank current cells must be regenerated; they are not silently backfilled from old code.
- Historical/pre-fix ENGINE rows quarantined from current rankings: **7,552/7,552**. They remain preserved as evidence.
...
- `SWITCH_MATRIX_TRB.xlsx`: 2026-07-26 23:30:46Z (0m old, 310,772 bytes)
- `SWITCH_MATRIX_TRB.csv.gz`: 2026-07-26 23:30:23Z (0m old, 57,997 bytes)
...
|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| `BOTTOM_C_DELAYED_EMERGENCY` | VLO_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 410.668% | 84.905% | 4.837× | 325.762pp | 23.360pp | 85.20% | 5 |
| `BOTTOM_C_DELAYED_EMERGENCY` | UUUU_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 23.764% | 26.197% | 0.907× | -2.433pp | -44.473pp | 19.69% | 16 |
| `BOTTOM_C_DELAYED_EMERGENCY` | UEC_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 104.503% | 22.648% | 4.614× | 81.855pp | 39.454pp | 18.58% | 2 |
| `BOTTOM_C_DELAYED_EMERGENCY` | TTD_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 514.440% | 54.325% | 9.470× | 460.115pp | 32.545pp | 96.62% | 1 |
| `BOTTOM_C_DELAYED_EMERGENCY` | SNDK_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 1206.567% | 467.087% | 2.583× | 739.480pp | -1119.070pp | 81.79% | 35 |
| `BOTTOM_C_DELAYED_EMERGENCY` | PBF_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 400.246% | 121.263% | 3.301× | 278.983pp | -307.026pp | 87.16% | 24 |
| `BOTTOM_C_DELAYED_EMERGENCY` | MU_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 946.794% | 204.905% | 4.621× | 741.889pp | -429.435pp | 58.03% | 3 |
| `BOTTOM_C_DELAYED_EMERGENCY` | MRVL_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 5.268% | 123.583% | 0.043× | -118.315pp | -1667.459pp | 29.69% | 26 |
| `BOTTOM_C_DELAYED_EMERGENCY` | MPC_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 150.362% | 88.480% | 1.699× | 61.882pp | 32.902pp | 28.98% | 5 |
| `BOTTOM_C_DELAYED_EMERGENCY` | LDOS_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 55.388% | 37.502% | 1.477× | 17.885pp | -12.370pp | 15.33% | 8 |
| `BOTTOM_C_DELAYED_EMERGENCY` | LAC_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 49.539% | 36.977% | 1.340× | 12.562pp | -59.793pp | 12.05% | 14 |
| `BOTTOM_C_DELAYED_EMERGENCY` | INTC_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 801.364% | 139.232% | 5.756× | 662.132pp | -162.653pp | 79.94% | 17 |
| `BOTTOM_C_DELAYED_EMERGENCY` | HL_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 37.217% | 21.954% | 1.695× | 15.262pp | -13.036pp | 18.33% | 12 |
| `BOTTOM_C_DELAYED_EMERGENCY` | EGO_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 50.735% | 23.025% | 2.203× | 27.710pp | 2.717pp | 21.11% | 5 |
| `BOTTOM_C_DELAYED_EMERGENCY` | DINO_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 450.961% | 90.701% | 4.972× | 360.260pp | -34.278pp | 84.98% | 5 |
| `BOTTOM_C_DELAYED_EMERGENCY` | ASTS_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 38.003% | 22.270% | 1.706× | 15.733pp | -28.574pp | 20.79% | 6 |
| `BOTTOM_C_DELAYED_EMERGENCY` | ARM_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 1373.309% | 126.604% | 10.847× | 1246.705pp | 290.871pp | 89.49% | 5 |
| `BOTTOM_C_DELAYED_EMERGENCY` | AMD_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 967.195% | 134.451% | 7.194× | 832.744pp | -213.614pp | 95.77% | 5 |
| `BOTTOM_C_DELAYED_EMERGENCY` | ALB_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 29.717% | 19.412% | 1.531× | 10.304pp | -55.998pp | 28.86% | 19 |
| `BOTTOM_C_DELAYED_EMERGENCY` | ACN_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 396.236% | 44.497% | 8.905× | 351.739pp | -4.742pp | 77.01% | 12 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | VLO_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 358.233% | 84.905% | 4.219× | 273.327pp | -29.075pp | 76.78% | 11 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | UUUU_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 15.231% | 26.197% | 0.581× | -10.966pp | -53.006pp | 21.56% | 6 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | UEC_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 71.800% | 22.648% | 3.170× | 49.152pp | 6.751pp | 21.64% | 1 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | TTD_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 567.547% | 54.325% | 10.447× | 513.222pp | 85.652pp | 86.02% | 10 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | SNDK_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 1176.162% | 467.087% | 2.518× | 709.074pp | -1149.475pp | 85.03% | 25 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | PBF_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 142.373% | 121.263% | 1.174× | 21.110pp | -564.898pp | 35.53% | 174 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | MU_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 538.088% | 204.905% | 2.626× | 333.183pp | -838.141pp | 53.26% | 5 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | MRVL_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 564.028% | 123.583% | 4.564× | 440.446pp | -1108.698pp | 48.10% | 17 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | MPC_LONG | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 106.265% | 88.480% | 1.201× | 17.785pp | -11.196pp | 26.19% | 13 |
| `BOTTOM_B_DELAYED_LOWER_TOP` | LDOS_SHORT | VEC_UNTOUCHED_OOS | LEGACY_UNSCOPED; return=LEGACY_UNSCOPED (LEGACY_UNSCOPED); TIM=LEGACY_UNSCOPED (LEGACY_UNSCOPED) | GRAY_REJECTED | 44.963% | 37.502% | 1.199× | 7.461pp | -22.794pp | 11.10% | 45 |
...
|---|---|---:|---|---:|
| ENGINE | stocks_repaired_20260725_c2 | 930 | 2026-07-26T23:29:50Z | 0m |
