...
TRADIER_GRID = [
    ...
    ("PPL_0p5",                    {"PARTIAL_PROFIT_LOCK_ENABLED": True, "PARTIAL_PROFIT_LOCK_GAIN_PCT_TRADIER": 0.5,  "PARTIAL_PROFIT_LOCK_ARM_GAIN_PCT_TRADIER": 0.75, "PARTIAL_PROFIT_LOCK_BE_BUFFER_PCT_TRADIER": 0.02}),
    ("PPL_1p0",                    {"PARTIAL_PROFIT_LOCK_ENABLED": True, "PARTIAL_PROFIT_LOCK_GAIN_PCT_TRADIER": 1.0,  "PARTIAL_PROFIT_LOCK_ARM_GAIN_PCT_TRADIER": 1.5,  "PARTIAL_PROFIT_LOCK_BE_BUFFER_PCT_TRADIER": 0.02}),
    ("PPL_1p5",                    {"PARTIAL_PROFIT_LOCK_ENABLED": True, "PARTIAL_PROFIT_LOCK_GAIN_PCT_TRADIER": 1.5,  "PARTIAL_PROFIT_LOCK_ARM_GAIN_PCT_TRADIER": 2.0,  "PARTIAL_PROFIT_LOCK_BE_BUFFER_PCT_TRADIER": 0.02}),
    ("PPL_disabled",               {"PARTIAL_PROFIT_LOCK_ENABLED": False}),
